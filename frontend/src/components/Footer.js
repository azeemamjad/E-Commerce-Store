                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm leading-relaxed opacity-80">
                            We provide the best products at competitive prices. Your one-stop shop for all your needs.
                        </p>
                    ...
                    <div>
                        ...
                        <p className="text-sm mb-4 opacity-80">Stay updated with our latest offers!</p>
                        <NewsletterForm />
                    </div>
                </div>

                <div className="border-t border-gray-800 mt-12 pt-8 text-sm text-center opacity-60">
